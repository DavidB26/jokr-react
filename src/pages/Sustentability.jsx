...
import Capacitar from "../assets/capacitar.webp";
import Invertir from "../assets/invertir.webp";
      ...
      <Wrapper>
        ...
        <div className='flex flex-col items-center justify-center px-3 pt-16 lg:flex-row lg:gap-28'>
          <div className='flex flex-col items-center justify-center pb-12 lg:pb-0'>
            <img className='w-80' src={Ambiente} alt='Ambiente' />
          ...
          <div className='flex flex-col items-center justify-center pb-12 lg:pb-0 '>
            <img className='w-80' src={Capacitar} alt='Ambiente' />
          ...
          <div className='flex flex-col items-center justify-center pb-12 lg:pb-0 '>
            <img className='w-80' src={Invertir} alt='Ambiente' />
